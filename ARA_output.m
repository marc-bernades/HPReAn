function ARA_output(Fluid, T_bw, T_tw, T_c, P_b, P_c, N, y, D, delta, bScaling, bTarget,N_target, n_LST_Sweep, alpha, beta, c, BF,Dy,H,H_w, U, S, V, varargin)
...
%     name_file_out = strcat(Fluid.Substance, '_Tbw_', num2str(T_bw), '_Ttw_', num2str(T_tw), '_Pb_', num2str(P_b), '_', bTarget, '_', bScaling, '_' , varargin{1});
    name_file_out = strcat(varargin{1});
